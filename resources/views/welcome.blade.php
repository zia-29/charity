             ...
             <div class="row">
                <div class="col-12 col-lg-6 order-2 order-lg-1">
                    <div class="welcome-content">
                        ...
                        <header class="entry-header">
                            <h2 class="entry-title">{{$sub->title}}</h2>
                        </header><!-- .entry-header -->
                ...
                <div class="col-12 col-lg-6 mt-4 order-1 order-lg-2">
                    <img src="{{$sub->photo ? $sub->photo->file :'http://placehold.it/400x300'}}" alt="welcome">
                </div><!-- .col -->
                     ...
                     {{-- @foreach($causes as $cas) --}}
                            ...
                            <div class="swiper-slide">
                                <div class="cause-wrap">
                                    <figure class="m-0">
                                            <img height=196.88px src="{{$cas->photo ? $cas->photo->file :'http://placehold.it/400x300'}}" alt="welcome">

                                        <div class="figure-overlay d-flex justify-content-center align-items-center position-absolute w-100 h-100">
                                            <a href="/causes" class="btn gradient-bg mr-2">View more</a>
                                        </div><!-- .figure-overlay -->
                                    </figure>

                                    <div class="cause-content-wrap">
                                        <header class="entry-header d-flex flex-wrap align-items-center">
                                            <h3 class="entry-title w-100 m-0"><a href="#">{{$cas->title}}</a></h3>
                                        </header><!-- .entry-header -->

                                        <div class="entry-content">
                                            <p class="m-0">{{$cas->content}}</p>
                                        </div><!-- .entry-content -->
